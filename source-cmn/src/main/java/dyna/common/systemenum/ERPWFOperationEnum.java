 ...
 * 功能描述: ERPworkFlowDoActionEnum
 * wangweixia 2012-3-29
 */
...
/**
 * @author wangweixia
 *         workFlow ERP集成导出动作枚举
 */
public enum ERPWFOperationEnum
{
	...
	private ERPWFOperationEnum(String No, String id, String ws, String type)
	{
		this.No = No;
		this.id = id;
		this.ws = ws;
	...
	public static ERPWFOperationEnum getById(String id)
	{
		for (ERPWFOperationEnum e : ERPWFOperationEnum.values())
		{
		...
		throw new IllegalArgumentException("no enum const class in " + ERPWFOperationEnum.class.getCanonicalName() + " with id: " + id);
	}
}