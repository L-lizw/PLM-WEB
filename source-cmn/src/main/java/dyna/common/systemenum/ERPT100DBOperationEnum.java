...
public enum ERPT100DBOperationEnum
{
	...
	CreateProFeaData("createClassification", "ProFeaDataCreate", "w"), // 产品特征

	CreateGlobalReplace("createGlobalR", "RepSubPBOMDataCreate", "w"), // 全局取代
	...
	GetJobNumber("getJobNumber", "PLMDataRunStatusGet", "r"),// 获取作业编号
	
	GetProCategory("getProCategory", "PLMDataRunStatusGet", "r"),// 获取产品分类码
	
	GetSupplier("getSupplier", "PLMDataRunStatusGet", "r"),//获取供应商
	
	GetItemGroup("getItemGroup", "PLMDataRunStatusGet", "r"),//获取料件主分群码
	;
	...
	private ERPT100DBOperationEnum(String id, String ws, String type)
	{
		this.id = id;
		this.ws = ws;
		this.type = type;
	...
	public static ERPT100DBOperationEnum getById(String id)
	{
		ERPT100DBOperationEnum[] all = ERPT100DBOperationEnum.values();
		...
		throw new IllegalArgumentException("No enum const class in " + ERPT100DBOperationEnum.class.getName() + " with id: " + id);
	}
