 ...
 * 
 */
class TransitionRestriction implements Cloneable, Serializable
{
	...
	public TransitionRestriction(WorkflowRouteType routeType, WorkflowRouteModeType routeModel, List<String> transitionRefList)
	{
